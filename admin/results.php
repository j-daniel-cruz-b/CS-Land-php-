                            ...
                            <form action="actionPOST.php" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" class="form-control" id="cost1Event">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="cost2Event">Precio VIP</label>
                                        <input type="number" class="form-control" id="cost2Event">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="nArtist">Número de Artista</label>
                                        <select class="custom-select" id="nArtist">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-5">
                                    <label for="inputCity">Imagen del Evento (Exibición [237x237px])</label>
